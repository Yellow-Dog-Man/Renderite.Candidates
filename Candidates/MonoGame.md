...
**Shading language(s):** HLSL & GLSL

**Rendering paths:** It's a framework, not a full engine

**Graphics API's:** OpenGL, DirectX 10

**Supported platforms:** Windows, Linux, MacOS, iOS, Android, PlayStation 4,PlayStation 5, Xbox (GDKX & XDK), Nintendo Switch 1 & 2  

**Oldest supported hardware:** Unkown

**VR API's:** As above its a framework, this would need to be implmented

**Activity:**
- Rough contributor count: 406
- Rough user/community size: Unknown

## AI Use
Seems to be a zero tolerance
https://github.com/MonoGame/MonoGame/blob/develop/CONTRIBUTING.md

# Existing usage / projects made with this
 Streets of Rage 4, Carrion, Celeste, Stardew Valley
