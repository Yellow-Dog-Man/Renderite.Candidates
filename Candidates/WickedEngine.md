...
## Basic Overview
**Programming language(s):** LUA C++ 

**Shading language(s):** Appears to be HLSL/OpenGL

**Rendering paths:** Unlisted
...
**Activity:**
- Rough contributor count: 58
- Rough user/community size: Unkown

## AI Use
Unknown as there is no statement.

# Existing usage / projects made with this
Look at the Project Github there is examples there
