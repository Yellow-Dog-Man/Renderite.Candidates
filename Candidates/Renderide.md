...
- Does not require a mod/plugin to use, though an empty mod is present as a placeholder for custom engine integrations in the future. 
...
**Ideal:**
- ⚠️ Ideally libVLC integration for maximum compatibility
